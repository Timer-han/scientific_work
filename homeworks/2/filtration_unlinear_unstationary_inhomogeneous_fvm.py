...
def get_diagonal(n, cell_size, time_interval, h_init):
    ...
    for i in range(1, n - 2):
        ...
        Kr = get_Kr(h_init)
        diagonal[i] = (c * (a + b) + a * (b + c)) / ((a + b) * (b + c)) + s * S * cell_size ** 2 / (2 * Kr * b * time_interval)
    ...
    diagonal[0] = (c * (a + b) + 2 * a * (b + c)) / ((a + b) * (b + c)) + s * S * cell_size ** 2 / (2 * Kr * b * time_interval)
    ...
    diagonal[-1] = (2 * c * (a + b) + a * (b + c)) / ((a + b) * (b + c)) + s * S * cell_size ** 2 / (2 * Kr * b * time_interval)
